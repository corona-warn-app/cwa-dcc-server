...
public class DccExceptionHandler {
   ...
   */
  @ExceptionHandler(DccServerException.class)
  public ResponseEntity<Void> handleDccServerExceptions(DccServerException exception) {
    log.warn("The dcc server response prevention due to: {}", exception.getMessage());
